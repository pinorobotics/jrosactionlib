 ...
 */
@MessageMetadata(type = GoalStatusArrayMessage.NAME, md5sum = "12ef789174f5252c94b427cdb93b2d0a")
public class GoalStatusArrayMessage implements Message {
    ...
    @Streamed public GoalStatusMessage[] status_list = new GoalStatusMessage[0];
