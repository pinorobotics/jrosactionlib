...
/**
 * <p>Actionlib requires for each action to have 3 separate messages: Goal, Feedback, Result.
 * 
 * <p>On top of that it will create for each such message an actionlib message where
 * the original message + actionlib metadata is stored.
 * 
 * <p>Since there are many message types involved it is easy to accidently mix-up message types
 * from different actions.
 * 
 * <p>To prevent this happening we use this iface. It consolidates all message types
